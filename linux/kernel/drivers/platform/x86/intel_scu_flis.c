...
static int scu_flis_probe(struct platform_device *pdev)
{
	...
	//config_pin_flis(ded_gpio18, PULL, DOWN_20K);	// PCB_ID2: GP_CORE_018      //simon1_liao as EE request,not set this gpio
	//config_pin_flis(ded_gpio16, PULL, DOWN_20K);	// PCB_ID3: GP_CORE_016 //Sean-- no set gpio_GP_CORE_016	
	//config_pin_flis(intd_dsi_te2, PULL, DOWN_20K);	// PCB_ID10: GP_CORE_007 //simon1_liao as EE request,not set this gpio
