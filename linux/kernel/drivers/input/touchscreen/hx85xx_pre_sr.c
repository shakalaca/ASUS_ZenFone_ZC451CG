...
//=============================================================================================================
	...
	#define HX_FLASH_TEST											// Vince @ 20140825	Add flash test function.	
	//TODO END
...
//=============================================================================================================
	...
	//----[HX_FW_UPDATE_BY_I_FILE]--------------------------------------------------------------------------start
		...
		{
			#include "20140827_ASUS_A502_GIS_D0505_02_08_ZC451_nCalibration_test3.cfg"
		};
		...
		{
			#include "ze451cg_20140827_ASUS_TOP_D0505_02_06_ZC451.cfg"
		};
		#else
		static unsigned char i_CTPM_FW[]=
		{
...
#ifdef HX_FLASH_TEST
			if (i_Needupdate && (i_Check_FW_Version() > 0 ))
#else    	
...
//=============================================================================================================
	...
	//----[ i2c ]---------------------------------------------------------------------------------------------start
		static int himax_ts_probe(struct i2c_client *client,const struct i2c_device_id *id)
		{
			...
			//#ifdef HX_PORTING_DEB_MSG
			printk("[HIMAX PORTING MSG]%s enter\n",__func__);
                        printk("<Red_debug> PRE SR DRIVER\n");
			//#endif	
...
#ifdef HX_FLASH_TEST
// None.	Vince @ 20140825		Moves to function i_update_func.
#else
			if(i_Needupdate)
#endif
			{
