...
#define DEFAULT_TEST_ITEMS  (_MAX_TEST | _MIN_TEST)

#define MAX_LIMIT_VALUE_GROUP1 4700 	// screen max limit
...
0x00,0xE0,0x01,0x56,0x03,0x0A,0x75,0x01,0x01,0x08,0x2D,0x0F,0x4B,0x2D,0x07,0x04,\
0x00,0x00,0x00,0x00,0x33,0x22,0x00,0x16,0x19,0x1C,0x14,0x8C,0x2C,0x0D,0x40,0x3E,\
0xA6,0x0F,0x00,0x00,0x00,0x9A,0x33,0x11,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x32,\
0x00,0x00,0x11,0x34,0x4D,0x4F,0x45,0x02,0x0A,0x00,0x00,0x04,0x80,0x36,0x00,0x7A,\
0x3A,0x00,0x74,0x3F,0x00,0x6E,0x44,0x00,0x69,0x4A,0x00,0x69,0x10,0x38,0x60,0x00,\
0xF0,0x5A,0x41,0x55,0x55,0x27,0x00,0x14,0x00,0x00,0x19,0x02,0x1D,0x46,0x32,0x14,\
0xDC,0x05,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x1A,0x18,0x16,0x14,0x12,0x10,0x0E,0x0C,0x0A,0x08,0x06,0x04,0x02,0xFF,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x10,\
0x0F,0x0C,0x0A,0x08,0x06,0x04,0x02,0x00,0x13,0x14,0x16,0x18,0x1C,0x1D,0x1E,0x1F,\
0x20,0x21,0x22,0x24,0x26,0x28,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x32,0x01\
    }

//TODO: define your config for Sensor_ID == 1 here, if needed

#define MAX_LIMIT_VALUE_GROUP2 5000 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 1500		// screen min limit
...
0x00,0xD0,0x02,0x00,0x05,0x05,0x05,0x01,0x01,0x08,0x1E,0x0F,0x50,0x32,0x03,0x05,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8C,0x2E,0x0E,0x50,0x52,\
0x0C,0x08,0x00,0x00,0x00,0x99,0x03,0x1D,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x38,0x60,0x00,\
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xBD,0x01\
    }
...
0x00,0x1C,0x02,0xC0,0x03,0x05,0x05,0x00,0x01,0x08,0x28,0x0F,0x50,0x32,0x03,0x05,\
0x00,0x00,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x00,0x8C,0x2E,0x0E,0x44,0x46,\
0xD9,0x0B,0x00,0x00,0x00,0x83,0x03,0x1D,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,0x12,0x14,0x16,0x18,0x1A,0x1C,0xFF,0xFF,\
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x14,0x13,\
0x12,0x10,0x0F,0x0C,0x0A,0x08,0x06,0x04,0x02,0x00,0x16,0x18,0x1C,0x1D,0x1E,0x1F,\
0x20,0x21,0x22,0x24,0x26,0x28,0x29,0x2A,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,\
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x6E,0x01\
    }
...
u16 max_limit_value = 4099;     // screen max limit
u16 min_limit_value = 2028;     // screen min limit
u16 max_limit_key = 12946;       // key_val max limit
u16 min_limit_key = 6329;        // key_val min limit
u16 uniformity_lmt = 49;        // screen uniformity in percent
...
static u32 shorttest_value = 0;
static u32 opentest_value = 0;
...
//add for factory test
//========================================================================================================
static ssize_t gtp_sysfs_shorttest_value_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	return scnprintf (buf, PAGE_SIZE,  "%d\n", shorttest_value);
}

static ssize_t gtp_sysfs_shorttest_value_store(struct device *dev,struct device_attribute *attr, char *buf)
{
	shorttest_value = simple_strtoul(buf,NULL,10);
	return scnprintf (buf, PAGE_SIZE,  "%d\n", shorttest_value);
}

static ssize_t gtp_sysfs_opentest_value_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	return scnprintf (buf, PAGE_SIZE,  "%d\n", opentest_value);
}

static ssize_t gtp_sysfs_opentest_value_store(struct device *dev,struct device_attribute *attr, char *buf)
{
	opentest_value = simple_strtoul(buf,NULL,10);
	return scnprintf (buf, PAGE_SIZE,  "%d\n", opentest_value);
}

static ssize_t gtp_sysfs_set_limit_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%s", "you can view this by \"cat rawdatavalue\" \n");
}

static ssize_t gtp_sysfs_set_limit_store(struct device *dev,struct device_attribute *attr, char *buf)
{
	u8 i=0;
	u32 res;
	char value[10];
	...
	res = simple_strtoul(&value,NULL,10);
	GTP_DEBUG("[Red_debug] res = %d\n",res);
	
	if(*(buf+3) == 'v')
	{
		if(*(buf+1) == 'a')
		{
			GTP_DEBUG("[Red_debug]change max_limit_value\n");
			max_limit_value = res;
		}
		else if(*(buf+1) == 'i')
		{
			GTP_DEBUG("[Red_debug]change min_limit_value\n");
			min_limit_value = res;
		}
		else GTP_DEBUG("[Red_debug]error name:2\n");
	}
	else if(*(buf+3) == 'k')
	{
		if(*(buf+1) == 'a')
		{
			GTP_DEBUG("[Red_debug]change max_limit_key\n");
			max_limit_key = res;
		}
		else if(*(buf+1) == 'i')
		{
			GTP_DEBUG("[Red_debug]change min_limit_key\n");
			min_limit_key = res;
		}
		else GTP_DEBUG("[Red_debug]error name:3\n");
	}
	else if(*buf == 'u')
	{
		GTP_DEBUG("[Red_debug]change uniformity_lmt value\n");
		uniformity_lmt = res;
	}
	else
	{
		GTP_DEBUG("[Red_debug] error name:1\n");
	}
	return -EPERM;
}
//========================================================================================================
...
//add for factory test
//========================================================================================================
static DEVICE_ATTR(shorttest_value, S_IRUGO|S_IWUSR, gtp_sysfs_shorttest_value_show, gtp_sysfs_shorttest_value_store);
static DEVICE_ATTR(opentest_value, S_IRUGO|S_IWUSR, gtp_sysfs_opentest_value_show, gtp_sysfs_opentest_value_store);
static DEVICE_ATTR(set_limit, S_IRUGO|S_IWUSR, gtp_sysfs_set_limit_show, gtp_sysfs_set_limit_store);
//========================================================================================================
...
//add for factory test
//=============================================================================
    ret = sysfs_create_file(goodix_debug_kobj, &dev_attr_opentest_value.attr);
    if (ret)
    {
        GTP_ERROR("%s: sysfs_create_version_file failed\n", __func__);
        return ret;
    ...
    ret = sysfs_create_file(goodix_debug_kobj, &dev_attr_shorttest_value.attr);
    if (ret)
    {
        GTP_ERROR("%s: sysfs_create_version_file failed\n", __func__);
        return ret;
    ...
    ret = sysfs_create_file(goodix_debug_kobj, &dev_attr_set_limit.attr);
    if (ret)
    {
        GTP_ERROR("%s: sysfs_create_version_file failed\n", __func__);
        return ret;
...
//add for factory test
//=============================================================================
	sysfs_remove_file(goodix_debug_kobj, &dev_attr_opentest_value.attr);
	sysfs_remove_file(goodix_debug_kobj, &dev_attr_shorttest_value.attr);
	sysfs_remove_file(goodix_debug_kobj, &dev_attr_set_limit.attr);
//=============================================================================
