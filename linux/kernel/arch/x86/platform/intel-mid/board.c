...
struct devs_id __initconst device_ids[] = {
	...
	{"hx8528", SFI_DEV_TYPE_I2C, 0, &no_platform_data, NULL},
#endif
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_DSX_I2C
...
/* Chih-Hsuan add Battery driver */
#ifdef CONFIG_A500CG_BATTERY_SMB347
	{"smb358", SFI_DEV_TYPE_I2C, 0, &smb347_platform_data},
#endif
#if 0
  ...
  /*  	{"hm2056", SFI_DEV_TYPE_I2C, 0, &hm2056_platform_data,
	...
	{"gc0339", SFI_DEV_TYPE_I2C, 0, &gc0339_platform_data,
                    			&intel_register_i2c_camera_device},*/
    	{"gc0310_raw", SFI_DEV_TYPE_I2C, 0, &gc0310_platform_data,//asus bsp kint change "gc0310_raw"
                    			&intel_register_i2c_camera_device},                           
	{"px3003b", SFI_DEV_TYPE_I2C, 0, &accel_cm3628_platform_data, NULL},					
...
//ChungYi
//asus bsp lew <
	{"ov5670_raw", SFI_DEV_TYPE_I2C, 0, &ov5670_platform_data,//asus bsp kint change "ov5670_raw"
					&intel_register_i2c_camera_device},
//asus bsp lew >
