...
const struct intel_v4l2_subdev_id v4l2_ids[] = {
	...
	{"imx132", RAW_CAMERA, ATOMISP_CAMERA_PORT_SECONDARY},
        ...
        {"gc0310_raw", RAW_CAMERA, ATOMISP_CAMERA_PORT_SECONDARY},//asus bsp kint change "gc0310_raw"
//asus bsp lew <
	{"ov5670_raw", RAW_CAMERA, ATOMISP_CAMERA_PORT_PRIMARY},//asus bsp kint change "ov5670_raw"
//asus bsp lew >
